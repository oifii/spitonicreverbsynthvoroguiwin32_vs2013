...
#include "stdafx.h"
#include "spitonicreverbsynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitonicreverbsynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicreverbsynthvoroguiwin32class"};				// the main window class name
